<nav class="sticky top-0 z-30 shadow bg-gray-800">
  <div class="container flex items-center py-6 px-[0px] xs:px-[18px] mx-auto capitalize text-gray-200">
    ...
    <div class="flex justify-end flex-1 mx-1.5">
      @auth
        <button id="dropdownInformationButton" data-dropdown-toggle="dropdownInformation" class="text-gray-200 bg-gray-600 font-normal rounded-lg text-md px-4 py-2.5 text-center inline-flex items-center" type="button">Profile <svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
